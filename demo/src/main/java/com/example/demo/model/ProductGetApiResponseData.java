...
public class ProductGetApiResponseData {
	...
	public ProductGetApiResponseData(String name, String category, Integer price, Integer in_stock,
			Integer reserved_quantities, Boolean is_available) {
